...
if cnt < st.session_state.nb_im:
	with col30:
		...
		plotter0 = read_and_display_stl(st.session_state.pl1[cnt*6+1])
	...
	with col1:
		...
		plotter1 = read_and_display_stl(st.session_state.pl1[cnt*6+1+1])
	...
	with col2:
		...
		plotter2 = read_and_display_stl(st.session_state.pl1[cnt*6+1+2])
	...
	with col3:
		...
		plotter3 = read_and_display_stl(st.session_state.pl1[cnt*6+1+3])
	...
	with col4:
		...
		plotter4 = read_and_display_stl(st.session_state.pl1[cnt*6+1+4])
	...
	with col5:
		...
		plotter5 = read_and_display_stl(st.session_state.pl1[cnt*6+1+5])
...
def update_counter():
	...
	if (st.session_state.count >= 1):
		with open("./outputs/" + st.session_state.time0 + "_PL1.txt", "a") as myfile:
			myfile.write("%s,%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+1]), '0'))
			myfile.write("%s,%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+2]), st.session_state.Score1))
			myfile.write("%s,%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+3]), st.session_state.Score2))
			myfile.write("%s,%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+4]), st.session_state.Score3))
			myfile.write("%s,%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+5]), st.session_state.Score4))
			myfile.write("%s,%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+6]), st.session_state.Score5))

			#myfile.write("%s\n%s\t%s\t%s\t%s\t%s\n" %(os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+1]), 
			#										os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+1+1]), 
			#										os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+2+1]), 
			#										os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+3+1]), 
			#										os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+4+1]), 
			#										os.path.basename(st.session_state.pl1[(st.session_state.count-1)*6+5+1])))
...
def master_callback():
	...
	#try:
	#	S = np.uint8(st.session_state.Score1) + \
	#		np.uint8(st.session_state.Score2) + \
	#		np.uint8(st.session_state.Score3) + \
	#		np.uint8(st.session_state.Score4) + \
	#		np.uint8(st.session_state.Score5)
	#	update_counter()
	#except:
	#	print('Could not validate all 5 scores !')
